                    ...
                    <div class="sm:col-span-6 pt-4">
                        ...
                        <div class="mt-1">
                            <input type="text" id="price" name="price"
                                class="block w-full  appearance-none bg-white border rounded-md py-2 px-3 text-base leading-normal  sm:text-sm sm:leading-5 @error('price') border-red-500 @enderror" />
                        </div>
                        @error('price')
                            <div class="text-sm text-red-500">{{ $message }}</div>
                        @enderror
