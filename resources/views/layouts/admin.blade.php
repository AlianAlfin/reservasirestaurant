...
<body class="font-sans antialiased">
    <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
        <div @click.away="open = false"
            class="flex flex-col flex-shrink-0 w-full text-gray-700 bg-slite-200 md:w-64 dark-mode:text-gray-200 dark-mode:bg-gray-800"
            x-data="{ open: false }">
            ...
            <nav :class="{ 'block': open, 'hidden': !open }"
                class="flex-grow px-4 pb-4 md:block md:pb-0 md:overflow-y-auto bg-slate-200">
                ...
                <x-admin-nav-link :href="route('Admin.category_blogs.index')" :active="request()->routeIs('Admin.category_blogs.index')">
                    {{ __('Category Blog') }}
                </x-admin-nav-link>
                {{-- <x-admin-nav-link :href="route('Admin.blogs.index')" :active="request()->routeIs('Admin.blogs.index')">
                    {{ __('Blog') }}
                </x-admin-nav-link> --}}
