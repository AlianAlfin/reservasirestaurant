...
@section('container')
    <div class="mt-28 font-serif">
        <h1 class="flex justify-center text-3xl font-bold text-slate-800">Testimoni</h1>
        <div class=" flex justify-end lg:mr-14 lg:mt-16 mt-20">
            <a href="/"
                class="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-orange-700 rounded-lg hover:bg-orange-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Back
        ...
        <div class="h-[1500px] lg:h-full gap-3 lg:mx-11 lg:mt-8 mt-6 grid lg:grid-cols-3">
            <div
                class="bg-white shadow-xl h-[290px] lg:mt-0 rounded-md border-orange-200 border-2 text center p-7 lg:hover:scale-105 lg:duration-300">
                <div class="grid grid-cols-2 w-1/2">
                    <img class="w-9 h-9 rounded-full" src="img/about2.jpg" alt="Rounded avatar">
                    <h1 class="lg:mb-4 mt-1 -ml-9 font-bold text-xl text-slate-700">Lorem</h1>
                </div>
                <p class="pt-7">Lorem ipsum
                    dolor
                    sit amet
                    consectetur adipisicing elit. Maiores ipsa neque vero dolorum quasi exercitationem perspiciatis deserunt
                    sequi libero voluptate, non soluta nihil at provident dolorem quia. Reiciendis, adipisci sapiente</p>

                <div class="flex items-center mt-3">
                    <svg class="w-4 h-4 text-yellow-400 mr-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
    ...
    <nav aria-label="Page navigation example" class="m-11 flex justify-end">
